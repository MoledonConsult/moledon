...
const RateCustomerModal = () => {
  return (
    <View style={styles.modalContainer}>
      ...
      <Text style={styles.modalSubtitle}>Kindly drop a review and rate your experience</Text>
      <TextInput style={styles.reviewInput} placeholder="Write your review here" multiline />
